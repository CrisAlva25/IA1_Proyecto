...
class NN_Model:
    ...
    def propagacion_adelante(self, dataSet):
        ...
        temp = (Z1, A1, D1, Z2, A2, D2, Z3, D3, A3, Z4, A4)
        #En A4 va la predicción o el resultado de la red neuronal
        return A4, temp
    ...
    def propagacion_atras(self, temp):
        ...
        W3 = self.parametros["W3"]
        W4 = self.parametros["W4"]
        (Z1, A1, D1, Z2, A2, D2, Z3, D3, A3, Z4, A4) = temp
